	...
	public function validate($dataArr)
	{
		...
		foreach($this->rules as $field=>$rules)
		{
				...
				if($ruleName=="required")
				{
					if(isset($this->data[$field]))
					{
						if($this->data[$field]==NULL)
						{
							...
							{
								$this->_errors[$field]=ucfirst($field)." Required";
							}
							break;
						}
					}
			...
			else if($ruleName == "compare")
			{
				if(is_array($ruleValue))
				{
					if(isset($ruleValue["compareto"]) && isset($ruleValue["operator"]))
					{
						if(isset($this->rules[$ruleValue["compareto"]]))
						{
							if(isset($this->data[$ruleValue["compareto"]]))
							{
								if($ruleValue["operator"] == "=")
								{
									if($this->data[$ruleValue["compareto"]] != $this->data[$field])
									{
										$this->_flag=false;
										if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$this->labels[$ruleValue["compareto"]]." do not match with ".$this->labels[$field];	
										}
										else if(isset($this->labels[$field]))
										{
											$this->_errors[$field]=$ruleValue["compareto"]." do not match with ".$this->labels[$field];
										}
										else if(isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$this->labels[$ruleValue["compareto"]]." do not match with ".$field;
										}
										else
										{
											$this->_errors[$field]=$ruleValue["compareto"]." do not match with ".$field;
										}
								...
								{
									if($this->data[$field] < $this->data[$ruleValue["compareto"]] )
									{
										$this->_flag=false;
										if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be greater than or equal to ".$this->labels[$ruleValue["compareto"]];	
										}
										else if(isset($this->labels[$field]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be greater than or equal to ".$ruleValue["compareto"];	
										}
										else if(isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$field. "should be greater than or equal to ".$this->labels[$ruleValue["compareto"]];	
										}
										else
										{
											$this->_errors[$field]=$field . "should be greater than or equal to ".$ruleValue["compareto"];	
										}
								...
								else if($ruleValue["operator"] == "<=")
								{
									if($this->data[$field] > $this->data[$ruleValue["compareto"]] )
									{
										...
										if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be less than or equal to".$this->labels[$ruleValue["compareto"]];	
										}
										else if(isset($this->labels[$field]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be less than or equal to".$ruleValue["compareto"];	
										}
										else if(isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$field. "should be less than or equal to ".$this->labels[$ruleValue["compareto"]];	
										}
										else
										{
											$this->_errors[$field]=$field . "should be less than or equal to".$ruleValue["compareto"];	
										}
								...
								else if($ruleValue["operator"] == "<")
								{
									if($this->data[$field] >= $this->data[$ruleValue["compareto"]] )
									{
										...
										if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be less than".$this->labels[$ruleValue["compareto"]];	
										}
										else if(isset($this->labels[$field]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be less than".$ruleValue["compareto"];	
										}
										else if(isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$field. "should be less than ".$this->labels[$ruleValue["compareto"]];	
										}
										else
										{
											$this->_errors[$field]=$field . "should be less than ".$ruleValue["compareto"];	
										}
								...
								else if($ruleValue["operator"] == ">")
								{
									if($this->data[$field] <= $this->data[$ruleValue["compareto"]] )
									{
										...
										if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be greater than".$this->labels[$ruleValue["compareto"]];	
										}
										else if(isset($this->labels[$field]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should be greater than".$ruleValue["compareto"];	
										}
										else if(isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$field. "should be greater than ".$this->labels[$ruleValue["compareto"]];	
										}
										else
										{
											$this->_errors[$field]=$field . "should be greater than ".$ruleValue["compareto"];	
										}
								...
								else if($ruleValue["operator"] == "!=")
								{
									if($this->data[$field] == $this->data[$ruleValue["compareto"]] )
									{
										...
										if(isset($this->labels[$field]) && isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should not be equal to ".$this->labels[$ruleValue["compareto"]];	
										}
										else if(isset($this->labels[$field]))
										{
											$this->_errors[$field]=$this->labels[$field] . "should not be equal to ".$ruleValue["compareto"];	
										}
										else if(isset($this->labels[$ruleValue["compareto"]]))
										{
											$this->_errors[$field]=$field. "should not be equal to ".$this->labels[$ruleValue["compareto"]];	
										}
										else
										{
											$this->_errors[$field]=$field . "should not be equal to ".$ruleValue["compareto"];	
										}
							...
							else
							{
								...
								if(isset($this->labels[$field]))
								{
									$this->_errors[$field]=$ruleValue["compareto"]." is required to compare with ".$this->labels[$field];
								}
								else
								{
									$this->_errors[$field]=$ruleValue["compareto"]." is required to compare with ".$field;
								}
								break;
							}
						...
						{
							die($ruleValue["compareto"]." is not present in rules for \"compare\" rule [$field] ");
						}
					}
					else
					{
						die("Please set  \"compareto\" and \"operator\" in rule value of \"compare\" rule [$field] ");
					}
				}
				else
				{
