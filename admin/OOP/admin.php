			        ...
			        <div class="collapse navbar-collapse" id="navbarNavDropdown">
			            <ul class="navbar-nav">
			            	<li class="nav-item dropdown dmenu">
			                    ...
			                    <div class="dropdown-menu">
			                    	<a class="dropdown-item" href="petcategory.php">Pets Category</a>
	          						<a class="dropdown-item" href="petsubcategory.php">Pets Subcategory</a>
			            ...
			            <ul class="navbar-nav">
			            	<li class="nav-item dropdown dmenu">
			                    ...
			                    <div class="dropdown-menu">
			                    	<a class="dropdown-item" href="material.php">Materials</a>
			            ...
			            <ul class="navbar-nav">
			            	<li class="nav-item dropdown dmenu">
			                    ...
			                    <div class="dropdown-menu">
									...
									<a class="dropdown-item" href="viewfood.php">View Food</a>
			                ...
			                <li class="nav-item">
			                    <a class="nav-link" href="listfeedbacks.php">Feedbacks</a>
			                </li>
			                <li class="nav-item dropdown dmenu">
			                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						          BLOG
						...
						<div class="wrap-form">
							...
							<div class="row">
								<div class="col-sm-8 col-md-8">
									<div class="img-video">
										<a href="../watch.html?v=vNDrLjOmUY4" class="popup-youtube play-video"><i class="fa fa-play fa-2x"></i></a>
