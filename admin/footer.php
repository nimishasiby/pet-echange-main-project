				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-4">
						<div class="footer-item">
							...
							<p>Pets are humanizing</p>
							<ul class="list-info">
								<li>
									<div class="info-icon text-primary">
										<span class="fa fa-map-marker"></span>
									</div>
									<div class="info-text">Edappally - Pukkattupady Rd, Edappally Toll, Edappally, Kochi, Kerala 682024</div> 
								</li>
								<li>
									<div class="info-icon text-primary">
										<span class="fa fa-phone"></span>
									</div>
									<div class="info-text">+91 7902403217</div>
								</li>
								<li>
									<div class="info-icon text-primary">
										<span class="fa fa-envelope"></span>
									</div>
									<div class="info-text">pet@gmail.com</div>
								</li>
							</ul>
						</div>
					</div>
