...
$fields=array("fd_name"=>"","fd_image"=>"","categoryname"=>"","fd_stock"=>"","fd_price"=>"","fd_description"=>"");
$rules=array("fd_name"=>array("required"=>""),"categoryname"=>array("required"=>""),"fd_stock"=>array("required"=>""),"fd_price"=>array("required"=>""),"fd_description"=>array("required"=>""));
